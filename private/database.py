...
class Database:
    ...
    def __init__(self, connection_string: str, db_name: str) -> None:
        ...
        self.characters.create_index("id")
        self.conversations.create_index("id")

    def save_character(self, character: Character) -> None:
        self.characters.insert_one(character.__dict__)
    ...
    def __load_conversation(self, data) -> Conversation:
        ...
        new_conversation = Conversation([self.get_character(i) for i in data["characters"]], parsed_messages)
        new_conversation.id = data["id"]
        return new_conversation
    
    def get_character(self, id: int) -> Character | None:
        result = self.characters.find_one({"id": id})
    ...
    def get_conversation(self, id: int) -> Conversation | None:
        result = self.conversations.find_one({"id": id})
